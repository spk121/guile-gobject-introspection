...
gboolean gig_amap_output_child_c(const GigArgMap *am, gint c_output_pos, gint *c_child_output_pos);
...
gboolean gig_amap_input_child_c(const GigArgMap *amap, gint c_input, gint *c_child_input);
